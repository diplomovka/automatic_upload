...
parser.add_argument('--max_size', '-x', type=int, default=1024,
    help='possible max size of the chunk, which will be created from unstructured data')
parser.add_argument('--simulator', '-s', nargs='?', const=True,
    help='generate random data for upload, possible only for unstructured data')
parser.add_argument('--simulator_rounds', '-r', type=int, default=10,
    help='generate')
parser.add_argument('--simulator_data_size', '-ds', type=int, default=64,
    help='total size of chunks, which will be generated by simulator')
